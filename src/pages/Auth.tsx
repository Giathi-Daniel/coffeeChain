      ...
      <div className="w-full max-w-md">
        ...
        <Card className="p-8 shadow-elevated">
          <div className="text-center mb-6">
            <h1 className="text-3xl font-bold mb-2">Welcome to CoffeeChain</h1>
            <p className="text-muted-foreground">
              Join thousands of farmers and buyers transforming the coffee supply chain
            </p>
          </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={userType} onValueChange={(value: "farmer" | "buyer") => setUserType(value)}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="buyer">Coffee Buyer</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
